...
These remain accepted contracts; only the bounded goods slice, its station jobs, equipment placement, the working oven, conveyor belts and company cash above have a runtime interface. No payment command exists yet.
