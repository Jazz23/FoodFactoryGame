...
- The goods payload is still not relational; world and registry are still separate databases.
...
These remain accepted contracts; only the bounded goods slice, its station jobs, equipment placement, the working oven and conveyor belts above have a runtime interface.
