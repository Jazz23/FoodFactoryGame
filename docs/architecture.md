...
These remain accepted contracts; only the bounded goods slice, its station jobs, equipment placement, the working oven, conveyor belts, company cash, the sell counter, supplier purchases, equipment purchases and spoilage timing/refrigeration above have a runtime interface. Sales credit cash inside the clock tick; purchases are the one player payment command.
